...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 04, 2022 lúc 09:21 PM
...
CREATE TABLE `can_bo` (
  ...
  `CB_MATKHAU` varchar(255) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `can_bo` (`CB_ID`, `CB_HOTEN`, `CB_NGAYSINH`, `CB_PHAI`, `CB_SDT`, `CB_EMAIL`, `CB_DIACHI`, `CB_MATKHAU`) VALUES
(3, 'Lê Hồng Nguyên', '2022-03-07', 'Nam', 127, 'nguyen@gmail.com', 'cần thơ', '1'),
(4, 'Lê Nguyên Hồng', '2022-03-05', 'Nữ', 987111222, 'Hong@gmail.com', 'Cà Mau', '1'),
(19, 'Lê Hồng Nguyên test', '1998-06-15', 'Nam', 1111, 'nguyen@gmail.com', 'can tho', '1'),
(2022, 'Lê Hồng Nguyên', '0000-00-00', 'Nam', 123, 'nguyentest@gmail.com', 'Cần Thơ', '1'),
(2023, 'test', '2022-04-15', 'Nữ', 111123, 'a@gmail.com', 'ádf', '1');
...
INSERT INTO `chi_so_phat_trien` (`T_ID`, `THANG`, `CHIEUCAO`, `CANNANG`) VALUES
(22, 'THANG 1', 112, 12),
(20, 'Tháng 1', 1, 2),
(21, 'Tháng 1', 2, 2),
(24, 'Tháng 1', 0, 0);
...
--
-- Cấu trúc bảng cho bảng `chi_so_phat_trien2`
--

CREATE TABLE `chi_so_phat_trien2` (
  `T_ID` int(11) NOT NULL,
  `THANG` varchar(255) NOT NULL,
  `CHIEUCAO2` float DEFAULT NULL,
  `CANNANG2` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Đang đổ dữ liệu cho bảng `chi_so_phat_trien2`
--

INSERT INTO `chi_so_phat_trien2` (`T_ID`, `THANG`, `CHIEUCAO2`, `CANNANG2`) VALUES
(20, 'Tháng 6', 100, 19),
(21, 'Tháng 6', 101, 18);
...
--
-- Cấu trúc bảng cho bảng `chi_so_phat_trien3`
--

CREATE TABLE `chi_so_phat_trien3` (
  `T_ID` int(11) NOT NULL,
  `THANG` varchar(255) NOT NULL,
  `CHIEUCAO3` float DEFAULT NULL,
  `CANNANG3` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Đang đổ dữ liệu cho bảng `chi_so_phat_trien3`
--

INSERT INTO `chi_so_phat_trien3` (`T_ID`, `THANG`, `CHIEUCAO3`, `CANNANG3`) VALUES
(20, '', 0, 0),
(21, '', 0, 0),
(22, 'Tháng 1', 111, 2);
...
CREATE TABLE `khoan_thu` (
  ...
  `KT_NOIDUNG` varchar(255) NOT NULL,
  `KT_GHICHU` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `khoan_thu` (`KT_ID`, `KT_NOIDUNG`, `KT_GHICHU`) VALUES
...
ALTER TABLE `chi_so_phat_trien`
  ADD KEY `csthang` (`THANG`),
  ADD KEY `cstre` (`T_ID`);

--
-- Chỉ mục cho bảng `chi_so_phat_trien2`
--
ALTER TABLE `chi_so_phat_trien2`
  ADD KEY `cs2` (`T_ID`),
  ADD KEY `css2` (`THANG`);

--
-- Chỉ mục cho bảng `chi_so_phat_trien3`
--
ALTER TABLE `chi_so_phat_trien3`
  ADD KEY `cs3` (`T_ID`),
  ADD KEY `cst` (`THANG`);
...
--
ALTER TABLE `can_bo`
  MODIFY `CB_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2024;

--
-- AUTO_INCREMENT cho bảng `khoan_thu`
--
ALTER TABLE `khoan_thu`
  MODIFY `KT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2042;
...
--
-- Các ràng buộc cho bảng `chi_so_phat_trien`
--
ALTER TABLE `chi_so_phat_trien`
  ADD CONSTRAINT `csthang` FOREIGN KEY (`THANG`) REFERENCES `thang` (`THANG`) ON DELETE CASCADE,
  ADD CONSTRAINT `cstre` FOREIGN KEY (`T_ID`) REFERENCES `tre` (`T_ID`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `chi_so_phat_trien2`
--
ALTER TABLE `chi_so_phat_trien2`
  ADD CONSTRAINT `cs2` FOREIGN KEY (`T_ID`) REFERENCES `tre` (`T_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `chi_so_phat_trien3`
--
ALTER TABLE `chi_so_phat_trien3`
  ADD CONSTRAINT `cs3` FOREIGN KEY (`T_ID`) REFERENCES `tre` (`T_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
