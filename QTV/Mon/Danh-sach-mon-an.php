<div class="content">
    ...
    <div class="noi-dung-100">
        <table class="table table-hover">
            <a href="index.php?b=them-mon-an"> <button type="button"
                    class=" trang btn btn-success width100 text-white">Thêm
                </button></a>
            <a href="index.php?b=danh-sach-loai-mon"> <button type="button" class=" trang btn btn-info text-white">Danh
                    sách
                </button></a>
            <tbody>
                ...
                foreach ($list_mon as $mon) {
                    extract($mon);
                    $xoa_mon="index.php?b=xoa-mon-an&M_ID=".$M_ID;
