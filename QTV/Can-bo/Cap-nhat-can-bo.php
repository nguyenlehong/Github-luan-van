...
<div class="content">
    <div class="tieu-de">
        <h3 class="font">Cập nhật thông tin cán bộ</h3>
    </div>
    <div class=noi-dung-80>
        ...
        <form action="index.php?b=cap-nhat-thong-tin-can-bo" method="POST" autocomplete="off">
            <fieldset disabled>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <a href="index.php?b=delete-can-bo&CB_ID=<?=$CB_ID?>">

                        <button type="button" class="btn btn-danger"> Xóa cán bộ</button>
                    </a>
