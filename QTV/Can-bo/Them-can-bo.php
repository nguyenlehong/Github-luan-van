<div class="content">
    ...
    <div class=noi-dung-80>
        <form action="index.php?b=insert-can-bo" method="POST" autocomplete="off">
            <fieldset disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 pad20px">
                    <input type="date" class="form-control " id="inputText3" name="ngaysinh" required max="2004-12-31">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <a href="index.php?b=danh-sach-can-bo"> <button type="button"
