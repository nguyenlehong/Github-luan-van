<div class="content">
    <div class="tieu-de">
        <h3 class="font">Tạo thực đơn v2</h3>
    </div>
    <div class=noi-dung-80>
        <form action="index.php?a=insert-thuc-don" method="POST" enctype="multipart/form-data">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr class="table-primary">
                        ...
                        <th class="width-table-600" scope="col">Tên món</th>
                        <th class="width-table-600" scope="col">Ảnh</th>
                        <th class="width-table-350" scope="col">Thao tác</th>
                    </tr>
                    <?php
                    $i=1;
            foreach ($list_mon as $mon) {
                ...
                <td>'.$i.'</td>
                <td>'.$M_TEN.'</td>
                <td> <img src="../Upload/'.$M_HINH.'" alt="" width="auto" height="100px"></td>
                <td><a href="" class="gachchan2">
