...
?><div class="content">
    ...
    <div class=noi-dung-80>
        ...
        ';
        ?>
        <form action="Xu-ly.php?b=luu-cap-nhat-thong-chi-tiet-tin-tre" method="POST" autocomplete="off">
            <fieldset disabled>
...
<div class="content">
    ...
    <div class="noi-dung-80b height400">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                <button type="submit" class="btn btn-success" value="luu" name="luu">Cập nhật</button>
